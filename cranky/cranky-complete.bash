...
_cranky() {
	...
	local cmds=(
		...
		"shell-helper -h handle-to-series-source series-codename package-name source-packages-path read-swm-property tree-type tree-main-path list-handles list-cycles list-variants config"
		"startnewrelease -h --help"
