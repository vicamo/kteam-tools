...
_cranky() {
	...
	local cmds=(
		...
		"shell-helper -h handle-to-series-source series-codename source-packages-path read_swm_property tree-type tree-main-path list-handles list-cycles list-variants config"
		...
		"update-dependents -h --help --ignore-abi-check"
