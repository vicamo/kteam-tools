# 		Default "<~/.bashrc>" file for Turning the Crank
...
# set your local $PATH to include the cranky tools directory
export PATH=~/kteam-tools/cranky:$PATH

# Set Debian fake root enviornment to avoid need for root for package build
